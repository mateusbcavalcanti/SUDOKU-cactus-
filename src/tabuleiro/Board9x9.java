...
public class Board9x9 extends Board {
	...
	@Override
	public void exibeMatriz(int[][] tabuleiro) {		//Imprime tabuleiro 9x9
	...
	@Override
	public void conflitantes(int tabuleiro[][], int linha, int coluna, int numJogado) throws ConflitanteException {
