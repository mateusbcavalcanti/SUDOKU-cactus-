...
public class IniciaJogo extends AtributosAux {
	...
	public String temporizador() { //Armazena o tempo de execu��o do jogo e coloca no estilo cronometro
	...
	public void setandoTabDif() { // Pega os dados da interface e fefine a dificuldade do tabuleiro e se eh 9x9 ou 16x16 e zera a quantidade de casas necess�ria 
